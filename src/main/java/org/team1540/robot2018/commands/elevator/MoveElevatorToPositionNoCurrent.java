...
public class MoveElevatorToPositionNoCurrent extends CommandGroup {

  public MoveElevatorToPositionNoCurrent(double target) {
    ...
    addSequential(new MoveElevatorNoCurrent(target));
  }
}
